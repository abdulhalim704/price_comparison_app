...
//Initialising Constractor
  TextFontStyle._();
  //new
  static final headline20w400cfffff = GoogleFonts.figtree(
      color: AppColors.cFFFFFF, fontSize: 20.sp, fontWeight: FontWeight.w400);
  static final headline20w700c000000 = GoogleFonts.figtree(
      color: AppColors.c000000, fontSize: 20.sp, fontWeight: FontWeight.w700);
  static final headline16w500cfffff = GoogleFonts.figtree(
      color: AppColors.cFFFFFF, fontSize: 16.sp, fontWeight: FontWeight.w500);
  static final headline14w600cfffff = GoogleFonts.figtree(
      color: AppColors.cFFFFFF, fontSize: 14.sp, fontWeight: FontWeight.w600);
  static final headline14w400c919191 = GoogleFonts.figtree(
      color: AppColors.c919191, fontSize: 14.sp, fontWeight: FontWeight.w400);
  static final headline12w500cffffff = GoogleFonts.figtree(
      color: AppColors.cFFFFFF, fontSize: 12.sp, fontWeight: FontWeight.w500);
  static final headline15w400cB9B9B9 = GoogleFonts.figtree(
      color: AppColors.cB9B9B9, fontSize: 15.sp, fontWeight: FontWeight.w400);
  static final headline20w600cffffff = GoogleFonts.figtree(
      color: AppColors.cFFFFFF, fontSize: 20.sp, fontWeight: FontWeight.w600);
  static final headline15w600cfffff = GoogleFonts.figtree(
      color: AppColors.cFFFFFF, fontSize: 15.sp, fontWeight: FontWeight.w600);
  static final headline14w500cfffff = GoogleFonts.figtree(
      color: AppColors.cFFFFFF, fontSize: 14.sp, fontWeight: FontWeight.w500);
  static final headline15w500cfffff = GoogleFonts.figtree(
      color: AppColors.cFFFFFF, fontSize: 15.sp, fontWeight: FontWeight.w500);
  static final headline18w600cfffff = GoogleFonts.figtree(
      color: AppColors.cFFFFFF, fontSize: 18.sp, fontWeight: FontWeight.w600);
  static final headline13w500c999999 = GoogleFonts.figtree(
      color: AppColors.c999999, fontSize: 13.sp, fontWeight: FontWeight.w500);
